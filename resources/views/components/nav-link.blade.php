...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-'.$color.'-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-'.$color.'-700 transition'
